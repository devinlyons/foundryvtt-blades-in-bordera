...
export class BladesClockSheet extends BladesSheet {
  ...
  /** @override */
	static get defaultOptions() {
	  return foundry.utils.mergeObject(super.defaultOptions, {
  	  ...
  	  template: "systems/blades-in-bordera/templates/actors/clock-sheet.html",
      width: 360,
      height: 400,
    });
  }
  ...
  async _updateObject(event, formData) {
    let image_path = `systems/blades-in-bordera/themes/${formData['system.color']}/${formData['system.type']}clock_${formData['system.value']}.svg`;
